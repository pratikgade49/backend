...
export const DataViewer: React.FC<DataViewerProps> = ({
  ...
  const handleFilterChange = (field: keyof DataViewRequest, value: string | number) => {
    setFilters(prev => ({
      ...prev,
      [field]: field === 'page' || field === 'page_size' ? Number(value) : value,
            ...
            <>
              ...
              <div className="flex items-center justify-between p-4 border-t border-gray-200 bg-white">
                <div className="text-sm text-gray-600">
                  Showing {((data.page - 1) * data.page_size) + 1} to {Math.min(data.page * data.page_size, data.total_records || 0)} of {(data.total_records || 0).toLocaleString()} results
                </div>
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <button
                    onClick={() => handleFilterChange('page', Math.min(data.total_pages || 1, data.page + 1))}
